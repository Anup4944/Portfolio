...
import n1Project from "../../public/images/projects/url.jpeg";
import n2Project from "../../public/images/projects/langauge.jpg";
...
const Project = ({ type, title, summary, img, link, githubLink }) => {
  return (
    <article
      className="w-full h-full flex flex-col items-center justify-center rounded-2xl border border-solid border-dark bg-light p-6 relative dark:bg-dark
       dark:border-light
   xs:p-4
    "
    >
